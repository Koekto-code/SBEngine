...
pause
cd objects
"mingw32-g++" gl.o physics.o object.o camera.o shader.o main.o sph.o sphs.o cube.o -s -o "../../Release/ctest.exe" -lglfw3dll -L"D:\Libs\glfw-3.3.4\mingw32\src" -Wl,-subsystem,windows
pause
