...
Mesh Model::convertMesh(const struct aiMesh *mesh, const struct aiScene *scene)
{
	...
	// Each sampler2D in fragment shader should be called "tex_"+T+N, where:
	//		T is type symbol. Available types
	//		(shaders for all of them not included):
	//			diffuse: d
	//			specular: s
	//			ambient: a
	//			emissive: e
	...
	//			shininess: i
	//			all other types: u
	//		N is hexadecimal number of texture in loading order from 0 to 0xFF.
